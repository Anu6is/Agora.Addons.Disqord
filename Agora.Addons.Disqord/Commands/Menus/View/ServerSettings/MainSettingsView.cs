        ...
        public MainSettingsView(GuildSettingsContext context)
            : base(context,
                  new List<GuildSettingsOption>
                  {
                      ...
                      new ("Early Offer Acceptance", "Accept offers made and close a listing before time ends.",(ctx, opts) => new AuctionAcceptView(ctx, opts)),
                      ...
                      new ("Confirm Transactions", "Confirm Market and Trade transactions before they are closed", (ctx, opts) => new TransactionConfirmationView(ctx, opts)),
                      new ("Recall Listings", "Allow users to withdraw a listing after an offer was made.", (ctx, opts) => new ListingRecallView(ctx, opts)),
