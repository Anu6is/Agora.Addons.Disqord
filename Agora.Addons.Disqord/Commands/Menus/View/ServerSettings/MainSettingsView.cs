        ...
        public MainSettingsView(GuildSettingsContext context)
            : base(context,
                  new List<GuildSettingsOption>
                  {
                      ...
                      //new ("Minimum Duration", "Set the minimum amount of time an item can be listed.",(ctx, opts) => new ListingDurationView(ctx, opts)),
                      //new ("Maximum Duration", "Set the maximum amount of time an item can be listed.",(ctx, opts) => new ListingDurationView(ctx, opts)),
